...
NB voir comment obtenir une partition égale 1400 EFA et 1400 CFA
...
partitions <- data_partition(bfi2, seed = 123, proportion = c(0.49, 0.50))
bfi2efa <- partitions$p_0.49
