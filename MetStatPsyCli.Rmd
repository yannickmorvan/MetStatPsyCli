...
Attention plutôt utiliser wls pour des données ordinales non normales (non normales = effet plancher / effet plafond, pas distribution de Gauss) et ml pour score échelles (Gauss distribution) NB si bcp de catégorie de réponse ex likert à 6 catégories ml "peut" faire l'affaire
...
partitions <- data_partition(bfi2, training_proportion = 0.5)
bfi2efa <- partitions$training
bfi2cfa <- partitions$test
...
Note more fit indices can be obtained with SemTools ex moreFitIndices(data)
